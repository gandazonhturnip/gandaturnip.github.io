<?php
    ...
    $query = mysqli_query($koneksi, "SELECT pesanan.nama_penerima, pesanan.nomor_telepon, pesanan.alamat, 
    pesanan.tanggal_pemesanan, user.nama, kota.kota, kota.tarif FROM pesanan JOIN user ON 
    pesanan.user_id=user.user_id JOIN kota ON kota.kota_id=pesanan.kota_id WHERE 
...
<div id="frame-faktur">
    ...
    <table class="table-list">
        ...
        <?php
            ...
            JOIN barang ON pesanan_detail.barang_id=barang.barang_id WHERE pesanan_detail.pesanan_id='$pesanan_id'");
    ...
    <div id="frame-keterangan-pembayaran">
        <p>Silahkan Lakukan Pembayaran ke Bank MANDIRI<br>
           Nomor : 0102030405 (AN. Tigattarup).<br>
           Setelah melakukan pembayaran, lalu silahkan konfirmasi
